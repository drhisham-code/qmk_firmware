...
void ergodox_left_led_1_on(void);
void ergodox_left_led_2_on(void);
void ergodox_left_led_3_on(void);

void ergodox_left_led_1_off(void);
void ergodox_left_led_2_off(void);
void ergodox_left_led_3_off(void);
#endif // LEFT_LEDS
